...
@section('title', __('admin/boats.positions.edit.title', ['boat.name' => $boat->name, 'boat_position.name' => __('admin/boats.positions.show.breadcrumb') . ' #' . $boatPosition->id]))
...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="#">@lang('admin/boats.positions.show.breadcrumb') #{{ $boatPosition->id }}</a></li>
    ...
    <form method="POST" action="{{ route('admin.boats.positions.update', [$boat, $boatPosition]) }}">
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('created_at_date') is-danger @enderror" type="date" id="created_at_date" name="created_at_date" value="{{ old('created_at_date', date('Y-m-d', strtotime($boatPosition->created_at))) }}" required>
                    </div>
            ...
            <div class="column">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('created_at_time') is-danger @enderror" type="time" step="1" id="created_at_time" name="created_at_time" value="{{ old('created_at_time', date('H:i:s', strtotime($boatPosition->created_at))) }}" required>
                    </div>
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('admin/boats.positions.edit.button')</button>
            </div>
        </div>
    </form>
@endsection
