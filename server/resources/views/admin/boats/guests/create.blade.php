...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.boats.guests.store', [$boat]) }}">
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="birthday">@lang('admin/boats.guests.create.birthday')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="email">@lang('admin/boats.guests.create.email')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="address">@lang('admin/boats.guests.create.address')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="postcode">@lang('admin/boats.guests.create.postcode')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="city">@lang('admin/boats.guests.create.city')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="country">@lang('admin/boats.guests.create.country')</label>
