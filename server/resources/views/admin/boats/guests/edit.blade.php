...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{ route('admin.boats.index') }}">@lang('boats.index.breadcrumb')</a></li>
            <li><a href="{{ route('admin.boats.show', $boat) }}">{{ $boat->name }}</a></li>
            <li><a href="#">{{ $boatGuest->name }}</a></li>
            <li class="is-active"><a href="{{ route('admin.boats.guests.edit', [$boat, $boatGuest]) }}">@lang('admin/boats.guests.edit.breadcrumb')</a></li>
        </ul>
    </div>

    <h1 class="title">@lang('admin/boats.guests.edit.header')</h1>

    <form method="POST" action="{{ route('admin.boats.guests.update', [$boat, $boatGuest]) }}">
        @csrf

        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="firstname">@lang('admin/boats.guests.edit.firstname')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="insertion">@lang('admin/boats.guests.edit.insertion')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="lastname">@lang('admin/boats.guests.edit.lastname')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="gender">@lang('admin/boats.guests.edit.gender')</label>
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="phone">@lang('admin/boats.guests.edit.phone')</label>
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('admin/boats.guests.edit.create_button')</button>
            </div>
        </div>
    </form>
@endsection
