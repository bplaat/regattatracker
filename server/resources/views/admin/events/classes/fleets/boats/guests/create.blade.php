...
@section('title', __('admin/events.classes.fleets.boats.guests.create.title', ['event.name' => $event->name, 'event_class.name' => $eventClass->name, 'event_class_fleet.name' => $eventClassFleet->name, 'boat.name' => $boat->name]))
...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li class="is-active"><a href="{{ route('admin.events.classes.fleets.boats.guests.create', [$event, $eventClass, $eventClassFleet, $boat]) }}">@lang('admin/events.classes.fleets.boats.guests.create.breadcrumb')</a></li>
        </ul>
    </div>

    <h1 class="title">@lang('admin/events.classes.fleets.boats.guests.create.header')</h1>

    <form method="POST" action="{{ route('admin.events.classes.fleets.boats.guests.store', [$event, $eventClass, $eventClassFleet, $boat]) }}">
        @csrf

        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="firstname">@lang('admin/events.classes.fleets.boats.guests.create.firstname')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="insertion">@lang('admin/events.classes.fleets.boats.guests.create.insertion')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="lastname">@lang('admin/events.classes.fleets.boats.guests.create.lastname')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="gender">@lang('admin/events.classes.fleets.boats.guests.create.gender')</label>
                        ...
                        <div class="select is-fullwidth @error('gender') is-danger @enderror">
                            <select id="gender" name="gender">
                                <option value="{{ App\Models\User::GENDER_MALE }}" @if (App\Models\User::GENDER_MALE == old('gender', App\Models\User::GENDER_MALE)) selected @endif>
                                    @lang('admin/events.classes.fleets.boats.guests.create.gender_male')
                                </option>
                                ...
                                <option value="{{ App\Models\User::GENDER_FEMALE }}" @if (App\Models\User::GENDER_FEMALE == old('gender', App\Models\User::GENDER_MALE)) selected @endif>
                                    @lang('admin/events.classes.fleets.boats.guests.create.gender_female')
                                </option>
                                ...
                                <option value="{{ App\Models\User::GENDER_OTHER }}" @if (App\Models\User::GENDER_OTHER == old('gender', App\Models\User::GENDER_MALE)) selected @endif>
                                    @lang('admin/events.classes.fleets.boats.guests.create.gender_other')
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="birthday">@lang('admin/events.classes.fleets.boats.guests.create.birthday')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="email">@lang('admin/events.classes.fleets.boats.guests.create.email')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="phone">@lang('admin/events.classes.fleets.boats.guests.create.phone')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="address">@lang('admin/events.classes.fleets.boats.guests.create.address')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="postcode">@lang('admin/events.classes.fleets.boats.guests.create.postcode')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="city">@lang('admin/events.classes.fleets.boats.guests.create.city')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="country">@lang('admin/events.classes.fleets.boats.guests.create.country')</label>
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('admin/events.classes.fleets.boats.guests.create.create_button')</button>
            </div>
        </div>
    </form>
@endsection
