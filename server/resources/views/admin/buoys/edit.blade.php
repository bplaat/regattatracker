...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.buoys.update', $buoy) }}">
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input @error('youtube_video') is-danger @enderror" type="text" id="youtube_video" name="youtube_video" value="{{ old('youtube_video', $buoy->youtube_video) }}" required>
            </div>
