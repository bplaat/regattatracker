...
@section('content')
    ...
    <div class="content">
        ...
        <div class="columns">
            <div class="column">
                <div class="buttons">
                    <a class="button is-link" href="{{ route('admin.buoys.create') }}">@lang('admin/buoys.index.create_button')</a>
                </div>
            </div>
            ...
            <form class="column" method="GET">
                <div class="field has-addons">
                    <div class="control" style="width: 100%;">
                        <input class="input" type="text" id="q" name="q" placeholder="@lang('admin/buoys.index.query_placeholder')" value="{{ request('q') }}">
                    </div>
                    <div class="control">
