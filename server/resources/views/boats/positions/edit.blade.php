...
@section('title', __('boats.positions.edit.title', ['boat.name' => $boat->name, 'boat_position.name' => __('boats.positions.show.breadcrumb') . ' #' . $boatPosition->id]))
...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="#">@lang('boats.positions.show.breadcrumb') #{{ $boatPosition->id }}</a></li>
    ...
    <form method="POST" action="{{ route('boats.positions.update', [$boat, $boatPosition]) }}">
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('boats.positions.edit.button')</button>
            </div>
        </div>
    </form>
@endsection
