...
@section('content')
    ...
    <form class="content" method="POST" enctype="multipart/form-data" action="{{ route('boats.store') }}">
        ...
        <div class="field">
            <label class="label" for="image">@lang('boats.create.image')</label>
            ...
            @else
                <p class="help">@lang('boats.create.image_message')</p>
            @enderror
        </div>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('sail_number') is-danger @enderror" type="text" id="sail_number" name="sail_number" value="{{ old('sail_number') }}">
                    </div>
