...
@section('content')
    ...
    <form method="POST" action="{{ route('boats.update', $boat) }}">
        ...
        <div class="field">
            <label class="label" for="MMSI">@lang('boats.edit.MMSI')</label>
        ...
        <div class="field">
            <label class="label" for="LOA">@lang('boats.edit.LOA')</label>
        ...
        <div class="field">
            <label class="label" for="BOA">@lang('boats.edit.BOA')</label>
        ...
        <div class="field">
            <label class="label" for="weight">@lang('boats.edit.weight')</label>
        ...
        <div class="field">
            <label class="label" for="sail_number">@lang('boats.edit.sail_number')</label>
        ...
        <div class="field">
            <label class="label" for="sail_area">@lang('boats.edit.sail_area')</label>
